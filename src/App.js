    ...
    <div className="flex min-h-screen items-center justify-center bg-[#312e2b] text-justify">
      ...
      <div>
        <div className="popover__wrapper mb-1">
          <button
            className="popover__title w-fit cursor-pointer gap-2 whitespace-nowrap rounded-md border border-gray-300 bg-[#ebecd0] px-4 py-1 text-sm font-medium text-[#273d11]"
